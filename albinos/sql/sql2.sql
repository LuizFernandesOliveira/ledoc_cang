...
CREATE SCHEMA IF NOT EXISTS `ledo_cang` ;
USE `sakila` ;

-- -----------------------------------------------------
-- Table `ledoc_cang`.`ledoc_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ledoc_cang`.`usuario` (
...
CREATE TABLE IF NOT EXISTS `sakila`.`film_actor` (
  ...
  CONSTRAINT `fk_film_actor_actor`
    ...
    REFERENCES `sakila`.`usuario` (`usuario_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
...
-- Table `sakila`.`table1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`table1` (
)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Placeholder table for view `sakila`.`view1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`view1` (`id` INT);
...
-- View `sakila`.`view1`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sakila`.`view1`;
USE `sakila`;
